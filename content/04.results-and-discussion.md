...
fragments that are small but the distance scores are too big. For the molecules we tested, a threshold of 0.01 leads to the most fragments
...
leads us to recommend a distruption threshold between 0.05 and 0.01 for our fragmentation scheme. While the current scheme does not provide a perfect solution, the
plots in figure {@fig:joint_plots} shows less fragments outside of the lower left region for thresholds 0.01 and 0.05. This scheme  preforms considerably better than other schemes such as the Pfizer
