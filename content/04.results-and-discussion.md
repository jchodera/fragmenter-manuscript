...
orthogonal but the WBO can be calculated via Löwdin normalization [@doi:10.1063/1.1747632; @doi:10/bdfk5f] which is how it is calculated in Psi4 [@doi:10.1021/acs.jctc.7b00174].
...
**[B]** AM1 ELF10 WBO distributions for the bond between the phenyl ring and $X_1$ in different chemical environments
**[E]** Selected QC torsion scan barrier heights vs AM1 ELF10 WBOs](images/figure_6.svg){#fig:subsituted_phenyls}
