...
most challenging molecules to fragment from our validation. To to that, we scored all resulting fragments using equation @eq:mmd_sqrd and chose the 100 molecules
