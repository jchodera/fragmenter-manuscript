...
optimal fragment and both schemes can perform equally poorly `[Hold for SI]`.{red}.
...
other molecules with similar chemical patterns up to eight bonds away `[hold for SI]`.{red}. Removing a nitrile group (Figure @fig:chemical_groups, C) and sulfonamide group (Figure @fig:chemical_groups, D)
