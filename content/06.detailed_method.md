...
Open Force Field consortium for fitting Parsley [@doi:]

Molecular mechanics torsion scans were run on QCArchive using OpenMM [@doi:10.1371/journal.pcbi.1005659] for the energy and gradient evaluations.
The molecules were parameterized with the OpenFF parsley Force Field (v1.0.0) [@doi:10.5281/zenodo.3483227]
