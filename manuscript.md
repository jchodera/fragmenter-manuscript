...
in a distribution of WBOs for all bonds in all fragments. The resulting dataset is exquisitely rich where very nuanced, long distance
chemical changes are detected.

{@fig:dabrafenib_wbo_dists} shows an example of the results of combinatorial
